...
@Component({
    ...
    template: `<div class="card">
        ...
        <span class="block text-muted-color font-medium mb-4">Dollar canadien</span>
        <ul class="p-0 m-0 list-none">
            ...
            <li class="flex items-center py-2 border-b border-surface">
                ...
                <span class="text-surface-900 dark:text-surface-0 leading-normal"><span class="text-primary font-bold">12</span> 6190 GN.</span>
            </li>
        </ul>
    </div>`
})
